...
public class Home extends JPanel {
    ...
    public Home() {
        ...
        // Painel para a barra de favoritos
        JPanel favoritesBarPanel = new JPanel();
        favoritesBarPanel.setBackground(new Color(192, 192, 192));
        favoritesBarPanel.setPreferredSize(new Dimension(getWidth(), 30));
        favoritesBarPanel.setLayout(new GridBagLayout());
        GridBagConstraints gbcFavorites = new GridBagConstraints();
        gbcFavorites.insets = new Insets(5, 5, 5, 5);
