...
public class AgendamentoPagamento extends JPanel {
	...
	public AgendamentoPagamento(Consulta consulta) {
		...
		panel.setBounds(-118, -81, 959, 841);
		add(panel);
		...
		dateChooser.setBounds(419, 222, 159, 25);
		...
		btnPagamento.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String linkPagamento = api.criarPagamento(String.valueOf(consulta.getId()), consulta.getNome(), consulta.getValorConsulta());
